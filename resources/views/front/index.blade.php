                   ...
                   <div class="owl-carousel">
                       <div class="carousel-item">
                           ...
                           <div class="carousel-text">
                               ...
                               <p>
                               Delicious food from the best cooks, delivered to your doorstep.
                               </p>
                               <div class="carousel-btn">
                                   <a class="btn custom-btn" href="{{url('/available_cooks')}}">View Menu</a>
                       ...
                       <div class="carousel-item">
                           ...
                           <div class="carousel-text">
                               <h1> <span>Best</span> Cooks</h1>
                               <p>
                                Discover best cooks and varitey of dishes on your place
                               </p>
                               <div class="carousel-btn">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="beverages" class="container tab-pane fade">
                            <div class="row">
                                ...
                                <div class="col-lg-5 d-none d-lg-block">
                                    <img src="{{asset('front/img/menu-beverage-img.jpg')}}" alt="Image">
                                </div>
                            </div>
                        </div>
                    </div>
