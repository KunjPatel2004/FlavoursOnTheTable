            ...
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
              ...
              <form method="post" action="{{url('admin/update_password')}}">@csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="current_pwd">Current Password<span style="color: red;">*</span></label>
                  ...
                  <div class="form-group">
                    <label for="new_pwd">New Password<span style="color: red;">*</span></label>
                    <input type="password" name="new_pwd" class="form-control" id="new_pwd" placeholder=" New Password">
                  </div>
                 
                  <div class="form-group">
                    <label for="confirm_pwd">Confirm Password<span style="color: red;">*</span></label>
